...
<body>
			...
			<nav
				...
				<div>
					<img src="img/logo.png"
						style="height: 0%; width: 46%; margin-left: -434%;">
				</div>
	...
	<!-- Navbar End -->
	<!-- Appointment Start -->
	<div class="container-fluid  my-5 py-5 a1">
			...
			<div class="row gx-5">
				...
				<div class="col-lg-6">
					<div class="bg-white text-center rounded p-5">
						...
						<div id="continer" modelAttribute="loginStatusMsg">
							<p>${loginStatusMsg}</p>
						</div>
							...
							<form action="staff-login" method="post">
								...
								<div class="col-12 ">
									<input id="username" type="email" name="username"
										...
										placeholder="Enter your Email id" style="height: 55px;">
									<label id="userNameErrorMsg" style="color: tomato"></label>
								</div>
								...
								<div class="col-12 ">
									<input id="password" type="password" name="password" required
										class="form-control bg-light border-0" placeholder="Password"
										style="height: 55px;"> <label id="passwordErrorMsg"
